...
If you want to increase the heartbeat interval, set the `code_servers.grpc_watch_interval` key. The value should be an integer that indicates the heartbeat interval, in seconds.
